...
export declare class ActionMetadata {
    ...
    isJsonTyped: boolean;
    contentTypeHandler: ResponseHandlerMetadata;
    locationHandler: ResponseHandlerMetadata;
    regirectHandler: ResponseHandlerMetadata;
    successCodeHandler: ResponseHandlerMetadata;
    emptyResultHandler: ResponseHandlerMetadata;
    nullResultHandler: ResponseHandlerMetadata;
    undefinedResultHandler: ResponseHandlerMetadata;
    errorCodeHandler: ResponseHandlerMetadata;
    redirectHandler: ResponseHandlerMetadata;
    renderedTemplateHandler: ResponseHandlerMetadata;
    headerHandlers: ResponseHandlerMetadata[];
